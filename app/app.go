...
var (
	_ runtime.AppI            = (*CosevmApp)(nil)
	_ servertypes.Application = (*CosevmApp)(nil)
)

// CosevmApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type CosevmApp struct {
	*baseapp.BaseApp
...
func (app *CosevmApp) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *CosevmApp) setPostHandler() {
...
func (app *CosevmApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *CosevmApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *CosevmApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *CosevmApp) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	return app.BaseApp.FinalizeBlock(req)
}

func (a *CosevmApp) Configurator() module.Configurator {
	return a.configurator
}

// InitChainer application update at chain initialization
func (app *CosevmApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *CosevmApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// LoadHeight loads a particular height
func (app *CosevmApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns CosevmApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *CosevmApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns CosevmApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *CosevmApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns CosevmApp's InterfaceRegistry
func (app *CosevmApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns CosevmApp's TxConfig
func (app *CosevmApp) TxConfig() client.TxConfig {
	return app.txConfig
}
...
func (a *CosevmApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *CosevmApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *CosevmApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *CosevmApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *CosevmApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *CosevmApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *CosevmApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *CosevmApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *CosevmApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *CosevmApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *CosevmApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *CosevmApp) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *CosevmApp) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return *app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *CosevmApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *CosevmApp) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.scopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *CosevmApp) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *CosevmApp) AutoCliOpts() autocli.AppOptions {
